...
//  CattleBattle
//
//  Created by Ding Ming on 29/3/15.
...
struct Constant {
    ...
    static let LAUNCH_Y_GAP : CGFloat = 80
    
    static let GAME_VIEW_RIGHT_BOUNDARY : CGFloat = 1024
    static let GAME_VIEW_LEFT_BOUNDARY : CGFloat = 0
